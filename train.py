...
optimizer = torch.optim.Adam([
                              ...
                              {'params': network.sa_module.parameters()}], lr=args.lr)
...
for i in tqdm(range(args.max_iter)):
    ...
    writer.add_scalar('loss_identity1', loss_identity1.item(), i + 1)
    writer.add_scalar('loss_identity2', loss_identity2.item(), i + 1)
